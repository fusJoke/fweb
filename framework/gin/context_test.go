...
import (
	...
	testdata "github.com/fusjoke/fweb/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/fusjoke/fweb/framework/gin.handlerNameTest$", c.HandlerName())
}
